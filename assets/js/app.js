...
<a class="navbar-brand" href="index.html">J</a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >Desarrollando una pasion por aprender.</p>
    </div>
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                <h6 class="display">Charlemos!</h6>
              </div>
                <form name="form1" action="https://formcarry.com/s/lIYmCB9orB" method="POST" accept-charset="UTF-8" >
                  <input id="name" type="text" name="name" placeholder="Tu Nombre" required/>
                  <input id="email" type="email" name="email" placeholder="Tu Mail" required/>                  
                  <textarea id="textArea" name="message" placeholder="Escribi un mensaje" required></textarea>
...
$(function submitAnimation() {
  ...
  $("#lnch").on("click", function () {
    ...
    if (name.value == "" || (/\d/.test(name.value))) {
      swal("Error !","Por favor ingresa un nombre valido!","error");
      return;
    }
    // Check if the email field is empty or email is not valid ex: test@@email.com
      ...
      swal("Error !","Por favor ingresa un mail valido!","error");
      return;
    }
    // Check if the message field is empty
    else if (text.value == "") {
      swal("Error !","Olvidaste ingresar tu mensaje!","error");
      return;
    }
    else {
